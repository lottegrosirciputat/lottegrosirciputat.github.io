...
<?php if ( $time >= 06 AND $time < 18 ): ?>
  ...
  <body id="content" style="background-image: url(include/assets/img/bg.img/lotte1.jpg);">

<?php else : ?>

  <body id="content" style="background-image: url(include/assets/img/bg.img/lotte2.jpg);">
    ...
    if (@$_SESSION['upload-patrol']) : ?>
        ...
        <script>
            ...
            $(document).ready(function(){
              ...
              $('#content').load('../applications/sgm_patrol/upload.php');
